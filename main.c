...
void turn_left_timed(void)
{

}

void turn_right_timed(void)
{
...
int main(void) {
	...
	/* USER CODE BEGIN 2 */
		...
		float d=0;
		float correction=0;
		float base_speed=8000; //50 percent duty cycle
		int left_speed=0;
		int right_speed=0;
		int error=0;
		int prev_error=0;
...
GPIO_InitStruct.Pin = RR_Pin | R_Pin | Bottom_Pin | Middle_Pin | Top_Pin | L_Pin
		| LL_Pin;
